            ...
            navAuth.innerHTML = `
                <div class="user-menu">
                    ...
                    <div class="user-dropdown">
                        ...
                        ${isAdmin ? `
                        <a href="panel-admin.html" class="dropdown-item" style="background: linear-gradient(90deg, rgba(196,30,58,0.1), rgba(212,175,55,0.1)); font-weight: 600;">
                            <i class="fas fa-shield-alt" style="color: ${isSuperAdmin ? '#d4af37' : '#003278'};"></i> Panel Admin
                        </a>
                        ` : ''}
                        <a href="#" class="dropdown-item" onclick="window.authSystem.viewProfile(event)">
